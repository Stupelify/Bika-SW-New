...
router.get('/', requirePermission('manage_menu', 'view_item', 'add_item', 'edit_item'), getVendors);
router.get('/:id', requirePermission('manage_menu', 'view_item', 'add_item', 'edit_item'), getVendorById);

...
// In React Native, environment variables via process.env need special config, but for now we default to the production URL, 
// or EXPO_PUBLIC_API_URL if configured.
const API_URL = process.env.EXPO_PUBLIC_API_URL || 'https://banquet.bikafood.com/api';
